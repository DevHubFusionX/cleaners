...
const serviceMeta = {
    'facility-maintenance': { icon: Shield, color: 'blue' },
    'cleaning-janitorial': { icon: Clock, color: 'green' },
    'landscaping': { icon: Award, color: 'emerald' },
    'security-oversight': { icon: Shield, color: 'indigo' },
    'pest-control': { icon: Shield, color: 'amber' },
    'facility-consultancy': { icon: Award, color: 'blue' },
};
...
const ServiceDetail = () => {
    ...
    return (
        <div className="bg-white min-h-screen">
            {/* Header / Hero */}
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#1a365d] overflow-hidden text-center text-white">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            ...
                            <div className="md:col-span-2" data-aos="fade-right">
                                <h2 className="text-3xl font-black text-[#1a365d] mb-6">Overview</h2>
                                ...
                                <h3 className="text-xl font-bold text-[#1a365d] mb-4">Key Features</h3>
                            ...
                            <div className="md:col-span-1" data-aos="fade-left">
                                <div className="bg-[#1a365d] p-8 rounded-3xl text-white sticky top-24">
                                    ...
                                    <div className="space-y-4">
                                        <Link to="/contact" className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-[#f6d274] text-[#1a365d] rounded-xl font-bold hover:bg-[#e5c163] transition-all duration-300">
