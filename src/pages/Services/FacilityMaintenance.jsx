                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div data-aos="fade-right">
                            <h2 className="text-3xl md:text-4xl font-black text-[#315347] mb-6">Expert Solutions for Your Property</h2>
                        ...
                        <div className="grid grid-cols-2 gap-4" data-aos="fade-left">
                            <div className="bg-gray-50 p-8 rounded-3xl text-center shadow-sm">
                                <Shield className="w-12 h-12 text-[#315347] mx-auto mb-4" />
                                <h4 className="font-bold text-[#315347]">Safety First</h4>
                            </div>
                            <div className="bg-gray-50 p-8 rounded-3xl text-center shadow-sm">
                                <Wrench className="w-12 h-12 text-[#315347] mx-auto mb-4" />
                                <h4 className="font-bold text-[#315347]">Expert Tools</h4>
                            </div>
                            <div className="bg-gray-50 p-8 rounded-3xl text-center shadow-sm">
                                <Clock className="w-12 h-12 text-[#315347] mx-auto mb-4" />
                                <h4 className="font-bold text-[#315347]">24/7 Response</h4>
                            </div>
                            <div className="bg-[#f6d274] p-8 rounded-3xl text-center shadow-md">
                                <h3 className="text-4xl font-black text-[#315347]">99%</h3>
                                <p className="text-[#315347] font-bold text-xs uppercase tracking-wider">Uptime</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 lg:py-28 bg-[#315347] relative overflow-hidden">
                <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4" data-aos="fade-up" data-aos-delay="100">
                        <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-[#f6d274] text-[#315347] rounded-xl font-bold hover:bg-[#e5c163] transition-all duration-300">
