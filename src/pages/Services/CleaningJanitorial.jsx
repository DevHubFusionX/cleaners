        ...
        <div className="bg-white min-h-screen">
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 grid grid-cols-2 gap-4" data-aos="fade-right">
                            <div className="bg-blue-50 p-8 rounded-3xl text-center shadow-sm border border-blue-100/50">
                                <Sparkles className="w-12 h-12 text-blue-500 mx-auto mb-4" />
                                <h4 className="font-bold text-[#1a365d]">Sparkling Clean</h4>
                            </div>
                            <div className="bg-amber-50 p-8 rounded-3xl text-center shadow-sm border border-amber-100/50">
                                ...
                                <h4 className="font-bold text-[#1a365d]">Eco-Friendly</h4>
                            </div>
                            <div className="bg-green-50 p-8 rounded-3xl text-center shadow-sm border border-green-100/50">
                                <Users className="w-12 h-12 text-green-500 mx-auto mb-4" />
                                <h4 className="font-bold text-[#1a365d]">Trained Staff</h4>
                            </div>
                            <div className="bg-[#1a365d] p-8 rounded-3xl text-center shadow-lg">
                                <Shield className="w-12 h-12 text-[#f6d274] mx-auto mb-4" />
                                <h4 className="font-bold text-white">Fully Insured</h4>
                            </div>
                        </div>
                        <div className="order-1 lg:order-2" data-aos="fade-left">
                            <h2 className="text-3xl md:text-4xl font-black text-[#1a365d] mb-6">Environmentally Conscious Janitorial Standards</h2>
                                ...
                                {features.map((feature, index) => (
                                    <li key={index} className="flex items-center gap-3">
                                        <div className="w-6 h-6 rounded-full bg-[#f6d274]/20 flex items-center justify-center flex-shrink-0">
                                            <CheckCircle2 className="w-4 h-4 text-[#1a365d]" strokeWidth={3} />
                                        </div>
            ...
            <section className="py-20 lg:py-28 bg-[#f6d274] relative overflow-hidden">
                <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
                    <h2 className="text-3xl md:text-5xl font-black text-[#1a365d] mb-8" data-aos="fade-up">Experience the Comtranz Clean.</h2>
                    <div className="flex flex-wrap justify-center gap-4" data-aos="fade-up" data-aos-delay="100">
                        <Link to="/contact" className="inline-flex items-center gap-2 px-10 py-5 bg-[#1a365d] text-white rounded-2xl font-bold text-lg hover:bg-[#152c4b] hover:scale-105 transition-all duration-300 shadow-xl">
                            <Mail className="w-5 h-5 text-[#f6d274]" />
                            Book a Cleaning Audit
                        </Link>
                        <a href="tel:+2348038102340" className="inline-flex items-center gap-2 px-10 py-5 bg-white text-[#1a365d] rounded-2xl font-bold text-lg hover:bg-gray-50 hover:scale-105 transition-all duration-300 border border-transparent shadow-xl">
                ...
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#1a365d]/5 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2"></div>
            </section>
        </div>
    );
};
