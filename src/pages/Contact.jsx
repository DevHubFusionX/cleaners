    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <section className="h-[400px] md:h-[500px] bg-gray-200 relative">
                ...
                */}
                <div className="absolute inset-0 flex items-center justify-center bg-[#065f46]/5">
                    <div className="text-center p-8">
                        <div className="w-16 h-16 bg-[#065f46] rounded-full flex items-center justify-center mx-auto mb-4">
                        ...
                        <h3 className="text-2xl font-black text-[#065f46] mb-2">Our Presence in Lagos</h3>
