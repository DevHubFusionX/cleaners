                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-4" data-aos="fade-up" data-aos-delay="200">
                            <Link
                                to="/contact"
                                className="inline-flex items-center gap-2 px-10 py-5 bg-[#f6d274] text-[#1a365d] rounded-2xl font-bold text-lg hover:bg-[#e5c163] hover:scale-105 transition-all duration-300 shadow-xl"
                            >
