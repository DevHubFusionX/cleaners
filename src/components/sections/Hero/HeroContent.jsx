    ...
    return (
        <div className="max-w-2xl" data-aos="fade-right">
            ...
            <div className="flex flex-wrap gap-4">
                <button className="bg-[#f6d274] hover:bg-[#e5c163] text-black px-7 py-3.5 rounded-lg font-bold text-sm uppercase tracking-wider transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                    Our Services
                ...
                <button className="border border-white/40 backdrop-blur-sm bg-white/5 text-white hover:bg-white/15 px-7 py-3.5 rounded-lg font-bold text-sm uppercase tracking-wider transition-all duration-300 flex items-center gap-2 hover:border-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
