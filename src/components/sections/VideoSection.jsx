        ...
        <section className="py-20 lg:py-28 bg-gray-50">
            <div className="container mx-auto px-4 lg:px-8">
                <div className="relative max-w-5xl mx-auto" data-aos="fade-up">
                    ...
                    <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
                        {!isPlaying ? (
                            <>
                                ...
                                {/* Overlay */}
                                <div className="absolute inset-0 bg-[#1a365d]/40 group-hover:bg-[#1a365d]/50 transition-colors duration-300"></div>
                                ...
                                >
                                    <div className="relative">
                                        ...
                                        <div className="relative w-20 h-20 md:w-24 md:h-24 bg-[#f6d274] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300">
                                            <svg className="w-8 h-8 md:w-10 md:h-10 text-[#1a365d] ml-1" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="absolute -top-6 -right-6 w-32 h-32 border-4 border-[#1a365d]/20 rounded-2xl -z-10"></div>
                </div>
            </div>
        </section>
    );
