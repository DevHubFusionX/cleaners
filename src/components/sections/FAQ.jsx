            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-2/5" data-aos="fade-right">
                        ...
                        {/* Static Help Card */}
                        <div className="bg-[#315347] rounded-2xl p-8 text-white relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 bg-[#f6d274] text-[#315347] px-6 py-3 rounded-xl font-bold text-sm hover:scale-105 transition-transform duration-300"
                                >
                                    Contact Support
                                </a>
                            </div>
