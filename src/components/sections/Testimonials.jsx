...
const Testimonials = () => {
    ...
    return (
        <section className="py-24 lg:py-32 bg-[#315347] relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10">
                ...
                <div className="max-w-5xl mx-auto relative group">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-12">
                                        <div className="relative flex-shrink-0">
                                            ...
                                            <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 bg-[#f6d274] p-1.5 sm:p-2 rounded-lg sm:rounded-xl shadow-lg">
                                                <Star className="w-3 h-3 sm:w-4 sm:h-4 text-[#315347] fill-current" />
                                            </div>
                                        </div>
                    ...
                    <div className="flex justify-center mt-8 sm:mt-12 gap-4 sm:gap-6">
                        <button
                            onClick={prevSlide}
                            className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 text-white flex items-center justify-center hover:bg-[#f6d274] hover:text-[#315347] hover:border-[#f6d274] transition-all duration-300 transform active:scale-95 group"
                        >
