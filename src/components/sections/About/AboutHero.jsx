...
import bgImage from '../../../assets/comtranz/image7.avif';
...
const AboutHero = () => {
    return (
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-[#1a365d] overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#f6d274]/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-[#f6d274]/5 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2"></div>
            </div>
            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
                <nav className="flex justify-center items-center gap-2 text-sm font-medium text-gray-400 mb-6" data-aos="fade-up">
                    ...
                    <span className="text-[#f6d274]">About Us</span>
                </nav>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white leading-tight tracking-tight mb-4" data-aos="fade-up" data-aos-delay="100">
                    Know More <br /> <span className="text-[#f6d274]">About Us</span>
                </h1>
                <p className="max-w-2xl mx-auto text-gray-300 text-lg md:text-xl leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                    Your dedicated partner in excellence, providing integrated facility management solutions across Nigeria since 2018.
                </p>
            </div>
        </section>
    );
