                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="w-full lg:w-1/2" data-aos="fade-right">
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-8 -right-4 md:-right-8 bg-[#1a365d] p-6 md:p-8 rounded-3xl shadow-2xl z-20 max-w-[240px]">
                    ...
                    <div className="w-full lg:w-1/2" data-aos="fade-left">
                        ...
                        <div className="space-y-5 text-gray-600 text-base md:text-lg leading-relaxed mb-8">
                            <p>
                                <strong className="text-[#1a365d]">{companyInfo.name}</strong> is a Nigerian-registered company ({companyInfo.rcNumber}) that has been delivering excellence in facility management since {companyInfo.established}.
                            </p>
                            <p>
                                Founded by <strong className="text-[#1a365d]">{companyInfo.founder}</strong>, we specialize in providing integrated facility management solutions that ensure your properties remain safe, functional, and well-maintained.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-8 pt-6 border-t border-gray-200">
                            <div>
                                ...
                                <div className="text-2xl font-black text-[#1a365d]">{companyInfo.established}</div>
                            </div>
                            <div className="h-12 w-px bg-gray-200"></div>
                            <div>
                                <div className="text-sm text-gray-500 mb-1">Location</div>
                                <div className="text-2xl font-black text-[#1a365d]">Lagos, NG</div>
                            </div>
                        </div>
                    </div>
                </div>
