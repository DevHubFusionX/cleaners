        ...
        <div data-aos="fade-left">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
                {coreValues.map((value, index) => (
                    ...
                    >
                        <div className="w-8 h-8 rounded-lg bg-[#315347] flex items-center justify-center">
                            <svg className="w-4 h-4 text-[#f6d274]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <span className="text-[#315347] font-semibold text-sm lg:text-base">{value.text}</span>
                    </div>
                ))}
            </div>
