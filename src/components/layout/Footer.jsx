...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#315347] pt-20 text-white relative overflow-hidden">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <form className="mb-8" onSubmit={(e) => e.preventDefault()}>
                            <div className="relative group">
                                ...
                                />
                                <button className="absolute right-2 top-2 bottom-2 bg-[#f6d274] hover:bg-[#e5c163] text-[#315347] rounded-lg px-4 flex items-center justify-center transition-colors">
                        ...
                        <div className="flex gap-4">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.name}
                                    href={social.url}
                                    className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-[#f6d274] hover:text-[#315347] hover:-translate-y-1 transition-all duration-300 group"
                                >
